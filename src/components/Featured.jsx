import { motion, useAnimation } from "framer-motion"; // Correctly import motion from framer-motion
import { Power4 } from "gsap/all"; // Ensure GSAP is imported if you are using it
...
function Featured() {
  ...
  return (
    <div className='w-full py-20'>
      <div className='w-full px-20 border-b-[1px] border-zinc-700 pd-20'>
      ...
      <div className='px-20'> 
        <div className='cards w-full flex gap-10 mt-10'>
          ...
          className='cardcontainer w-1/2 h-[75vh]'>
            <div className='card w-full h-full relative rounded-xl '>
          ...
          className='cardcontainer w-1/2 h-[75vh]'>
            <div className='card w-full relative h-full rounded-xl '>
